...
import EmployeeCreate from "../Employee/create_employee";
import ClientOnBoard from "../settings/onboard/clientOnBoard";
...
export const routes = [
  ...
  { path: `/client/onboard`, Component: <ClientOnBoard /> },
